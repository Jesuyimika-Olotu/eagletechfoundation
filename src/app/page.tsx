...
//       {/* Statistics Section */}
//       <section className="bg-[#0F1F4C] py-21.5 px-6 md:px-28 flex flex-col md:flex-row gap-x-12">
//         {/* Text Content */}
...
//       {/* Blue line */}
//       <div className="px-28">
//         <div className="w-full h-[4px] bg-[#0F1F4C]"></div>
//       </div>
//       {/* Volunteer section */}
...
export default function Page() {
  return (
    <>
      ...
      <section className="relative w-full h-[70vh] sm:h-[80vh] lg:h-[90vh]">
        ...
        <div className="absolute inset-0 flex items-center px-6 sm:px-12 lg:px-28">
          <div className="text-left max-w-3xl space-y-4">
            <span className="inline-block bg-white text-blue-700 text-sm sm:text-base font-semibold px-6 py-2 rounded-full shadow">
              Eagletech Foundation
            </span>
            ...
            <Link
              href="#mission"
              className="inline-block bg-blue-700 text-white font-medium px-6 py-3 rounded-lg shadow hover:bg-blue-600 transition-all duration-300"
            >
              Learn More
            </Link>
          </div>
      ...
      <section
        id="mission"
        className="bg-gray-50 py-16 sm:py-24 px-6 sm:px-12 lg:px-28"
      >
      ...
      {/* VISION SECTION */}
      <section className="bg-blue-100 py-16 sm:py-24 px-6 sm:px-12 lg:px-28 text-center">
        <h2 className="text-blue-700 font-bold text-sm sm:text-base tracking-wider uppercase mb-4">
          Our Vision
        </h2>
          ...
          <div className="lg:w-1/2 space-y-6 flex flex-col justify-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-bold text-lg">Empowerment</p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-bold text-lg">Inclusivity</p>
                  <p className="text-gray-700 leading-relaxed">
                    We ensure equal participation and respect for all
                    individuals.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-bold text-lg">Compassion</p>
                  <p className="text-gray-700 leading-relaxed">
      ...
      {/* STATISTICS SECTION */}
      <section className="bg-[#0F1F4C] text-white py-16 sm:py-24 px-6 sm:px-12 lg:px-28">
      ...
      <section className="py-16 sm:py-24 px-6 sm:px-12 lg:px-28">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight max-w-4xl">
            We are creating a place where children with special needs can
            thrive.
          </h3>
            ...
            {[1, 2, 3].map((project) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 p-6 flex flex-col justify-end">
                  ...
                  <button className="bg-white text-blue-700 px-4 py-2 rounded-lg font-medium hover:bg-blue-700 hover:text-white transition-all duration-300">
                    Learn More
                  </button>
                </div>
              </div>
